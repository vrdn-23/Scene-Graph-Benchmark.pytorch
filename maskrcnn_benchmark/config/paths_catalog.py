...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "GQA": {
            "img_dir": "gqa/images",
            "roidb_file": "gqa/VG-SGG-GQA-with-attri-comb.h5",
            "dict_file": "gqa/VG-SGG-GQA-dicts-with-attri.json",
            "image_file": "gqa/comb_image_data.json",
        },
    }
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            data_start_path = cfg.DATASETS.DATA_STR
            data_dir = DatasetCatalog.DATA_DIR
